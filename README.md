...
# 🎮 Flock of the Seraphim — Community Edition

**A standalone Community Edition of Flock of the Seraphim.**
...
Flock of the Seraphim is a fantasy adventure RPG set in a skybound realm of floating sanctuaries and ancient celestial orders. Players command a winged company, explore open aerial territories, engage in tactical squad combat, and uncover the lore of the Seraphim lineage. This Community Edition is a self-contained package that runs as a standalone build with no storefront or additional software required.

This build is for PC players who want a self-contained, offline version of Flock of the Seraphim without a storefront client.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4290680/55c935b637887fe9b69fbea878fe818bfddb8dc0/ss_55c935b637887fe9b69fbea878fe818bfddb8dc0.1920x1080.jpg?t=1788375246" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4290680/19542491bdf246a369ece59d9343beb586261cc3/ss_19542491bdf246a369ece59d9343beb586261cc3.1920x1080.jpg?t=1788375246" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4290680/44abfab9bd44b055ddbaadc7b48eb4ad49f58442/ss_44abfab9bd44b055ddbaadc7b48eb4ad49f58442.1920x1080.jpg?t=1788375246" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Japanese, Simplified Chinese
...
- 🪽 **Aerial Exploration** — Traverse a seamless open-world of floating islands and cloud-covered ruins.
- ⚔️ **Tactical Squad Combat** — Command a flock of Seraphim warriors in position-based encounters.
- 📜 **Branching Storyline** — Shape the fate of the celestial order through narrative choices.
- 🛠️ **Wing Crafting System** — Forge and upgrade feathered gear from materials gathered in the wilds.
- 🗺️ **Open-World Progression** — enable sanctuaries, shrines, and side regions at your own pace.
- 🎮 **Full Controller Support** — Native gamepad support with remappable bindings.
- 💾 **Offline Play** — Runs entirely offline as an independent release.
- 🌐 **LAN or Direct Connection** — Co-op sessions supported via LAN or direct P2P connection.
- 🗂️ **All Content Included** — The self-contained package includes all released content and DLC.
- ⚙️ **Graphics Options** — Scalable quality presets, resolution scaling, and uncapped framerate.

- **Compression:** Lossless
- **Install Time:** ~10 minutes on SSD, ~25 minutes on HDD
- **Recoding:** none
- **Selective Download:** Full package only; no selective components

---

## 📦 DLCs Included

- Wings of Dawn Expansion
- Celestial Choir Cosmetic Pack
...
| **Storage** | 30 GB available space | 30 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12 compatible sound card |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\FlockoftheSeraphim\Saved`
